...
class _OwnerChatScreenState extends State<OwnerChatScreen> {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('Communicate with your clients',
  ...
  Widget _buildConversationList(ThemeData theme) {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text('Customers will appear here after booking or bidding',
                style: theme.textTheme.bodySmall
                    ?.copyWith(color: AppTheme.onSurfaceMuted)),
          ],
        ),
    ...
    return RefreshIndicator(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (_, i) =>
            _buildConversationTile(theme, filtered[i]),
      ),
    );
  }
  ...
  Widget _buildConversationTile(
    ...
    final customerPhoto = conv['other_user_photo'];
    final customerName = conv['name'] ?? '';
  ...
  void _openChat(Map<String, dynamic> conv) {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (_) => OwnerChatDetailScreen(conversation: conv)),
...
class OwnerChatDetailScreen extends StatefulWidget {
  ...
  const OwnerChatDetailScreen({super.key, required this.conversation});
          ...
          children: [
            Container(
              ...
              child: conv['other_user_photo'] != null
                  ? ClipOval(
                      child: CustomImageWidget(
                        imageUrl: conv['other_user_photo'],
                        width: 36,
                        height: 36,
                        fit: BoxFit.cover,
                      ),
